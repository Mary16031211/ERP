...
class StackType
{
    ...
    DATA3[] data=new DATA3[MAXLEN+1]; 		//数据元素				//����Ԫ�� 
    int top; 								//栈顶
    ...
    boolean STIsEmpty(StackType s) 					//判断空栈
    {
    	boolean t;
    	t=(s.top==0);
        return t;
    ...
    boolean STIsFull(StackType s) 					//判断是否满栈
    {
    	boolean t;
    	t=(s.top==MAXLEN);
        return t;
    ...
    int PushST(StackType s,DATA3 data)			//入栈 
    {
         if((s.top+1)>MAXLEN)
         {
